...
import com.vudn.myfood.adapter.comment.HinhBinhLuanAdapter;
...
public class HienThiChiTietBinhLuanActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.item_binhluan);
            ...
            storageHinhUser.getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
                ...
                public void onSuccess(byte[] bytes) {
                    ...
                    if(bitmapList.size() == binhLuanModel.getHinhanhBinhLuanList().size()){
                        HinhBinhLuanAdapter adapterRecyclerHinhBinhLuan = new HinhBinhLuanAdapter(HienThiChiTietBinhLuanActivity.this,R.layout.custom_layout_hinhbinhluan,bitmapList,binhLuanModel,true);
