package com.vudn.myfood.view.comment;
...
import com.vudn.myfood.adapter.comment.HienThiHinhBinhLuanDuocChonAdapter;
...
import com.vudn.myfood.view.dialog.DanhGiaDialog;
...
public class BinhLuanActivity extends BaseActivity implements View.OnClickListener, DanhGiaDialog.OnDanhGiaListener {
    ...
    HienThiHinhBinhLuanDuocChonAdapter adapterHienThiHinhBinhLuanDuocChon;
    ImageButton btnRate;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CHONHINHBINHLUAN) {
            if (resultCode == RESULT_OK) {
                ...
                adapterHienThiHinhBinhLuanDuocChon = new HienThiHinhBinhLuanDuocChonAdapter(this, R.layout.activity_hienthibinhluanduocchon, listHinhDuocChon);
