...
import com.vudn.myfood.adapter.comment.ChonHinhBinhLuanAdapter;
...
public class ChonHinhBinhLuanActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    ChonHinhBinhLuanAdapter adapterChonHinhBinhLuan;
    TextView txtXong;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapterChonHinhBinhLuan = new ChonHinhBinhLuanAdapter(this,R.layout.item_chonhinhbinhluan,listDuongDan);
