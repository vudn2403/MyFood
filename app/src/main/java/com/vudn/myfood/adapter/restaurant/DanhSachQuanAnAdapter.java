...
public class DanhSachQuanAnAdapter extends RecyclerView.Adapter<DanhSachQuanAnAdapter.ViewHolder> {
    public static final String TAG = "DanhSachQuanAnAdapter";
    private List<QuanAnModel> quanAnModelList;
    private int resource;
    private Context context;
    private OnQuanAnModelClickListener quanAnModelClickListener;
    private int itemPosition;


    public DanhSachQuanAnAdapter(Context context, List<QuanAnModel> quanAnModelList, int resource, OnQuanAnModelClickListener onQuanAnModelClickListener) {
        this.quanAnModelList = quanAnModelList;
        this.resource = resource;
        this.context = context;
        setQuanAnModelClickListener(onQuanAnModelClickListener);
    }

    public void setQuanAnModelClickListener(OnQuanAnModelClickListener quanAnModelClickListener) {
        this.quanAnModelClickListener = quanAnModelClickListener;
    }

    @Override
    public DanhSachQuanAnAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final DanhSachQuanAnAdapter.ViewHolder holder, int position) {
        ...
        if (quanAnModel.isGiaohang()) {
            ...
            holder.btnDatMonOdau.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    quanAnModelClickListener.onDatGiaoHangClick(holder.getAdapterPosition());
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                quanAnModelClickListener.onQuanAnModelClick(holder.getAdapterPosition());
    ...
    public QuanAnModel getQuanAnModel(int position) {
        return quanAnModelList == null ? null : quanAnModelList.get(position);
    }
    ...
    public void filter(String theloai, String khuvuc){
        for (int i = 0; i < quanAnModelList.size();){
            if (quanAnModelList.get(i).getTheloai().contains(theloai) && quanAnModelList.get(i).getKhuvuc().contains(khuvuc)){
                i ++;
            }else {
                removeItem(i);
            }
    ...
    private void removeItem(int i) {
        quanAnModelList.remove(i);
        notifyDataSetChanged();
    }


    public interface OnQuanAnModelClickListener {
