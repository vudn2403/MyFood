...
public class BinhLuanApdater extends RecyclerView.Adapter<BinhLuanApdater.ViewHolder> {
    ...
    public BinhLuanApdater(Context context, int layout, List<BinhLuanModel> binhLuanModelList) {
    ...
    @Override
    public BinhLuanApdater.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final BinhLuanApdater.ViewHolder holder, int position) {
            ...
            storageHinhUser.getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
                ...
                public void onSuccess(byte[] bytes) {
                    ...
                    if (bitmapList.size() == binhLuanModel.getHinhanhBinhLuanList().size()) {
                        HinhBinhLuanAdapter adapterRecyclerHinhBinhLuan = new HinhBinhLuanAdapter(context, R.layout.custom_layout_hinhbinhluan, bitmapList, binhLuanModel, false);
