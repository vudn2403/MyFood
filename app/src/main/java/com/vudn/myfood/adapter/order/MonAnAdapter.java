...
public class MonAnAdapter extends RecyclerView.Adapter<MonAnAdapter.HolderMonAn> {
    ...
    public MonAnAdapter(Context context, List<MonAnModel> monAnModelList, OnSoLuongMonAnThayDoiListener onSoLuongMonAnThayDoiListener) {
    ...
    public HolderMonAn onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_dat_hang_mon_an, parent, false);
    ...
    public void onBindViewHolder(final HolderMonAn holder, int position) {
        ...
        holder.imgTangSoLuong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (datMonTag != null) {
                    MonAnAdapter.datMonList.remove(datMonTag);
                }*/
                ...
                MonAnAdapter.datMonList.add(datMon);*/
            ...
            public void onClick(View v) {
                ...
                if (dem > 0) {
                    ...
                    if (dem == 0) {
                        ...
                        MonAnAdapter.datMonList.remove(datMon);*/
                    } else {
                        ChiTietDonHangModel tag = (ChiTietDonHangModel) v.getTag();
                        if (tag != null) {
                            chiTietDonHangModelList.remove(tag);
