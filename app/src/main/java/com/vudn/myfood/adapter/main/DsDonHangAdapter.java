...
public class DsDonHangAdapter extends RecyclerView.Adapter<DsDonHangAdapter.ViewHolder> {
    private Context context;
    private LayoutInflater inflater;
    List<DonHangModel> donHangModelList;
    OnDonHangClickListener onDonHangClickListener;

    public DsDonHangAdapter(Context context, List<DonHangModel> donHangModelList, OnDonHangClickListener onDonHangClickListener) {
