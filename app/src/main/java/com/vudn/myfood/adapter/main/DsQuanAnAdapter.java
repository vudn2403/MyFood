...
public class DsQuanAnAdapter extends RecyclerView.Adapter<DsQuanAnAdapter.ViewHolder> {
    public static final String TAG = "DsQuanAnAdapter";
    ...
    public DsQuanAnAdapter(Context context, List<QuanAnModel> quanAnModelList, int resource, OnQuanAnModelClickListener onQuanAnModelClickListener) {
    ...
    @Override
    public DsQuanAnAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final DsQuanAnAdapter.ViewHolder holder, int position) {
